...
#SBATCH -o staralign/2mm_jg.out # Standard output
#SBATCH -e staralign/2mm_jg.err # Standard error
...
--variant /n/regal/pringle_lab/koleaz/mitosnps/gvcfs_2mm/2mm_vcfs.list \
-o /n/home01/kzimmerman/mito_fastqs/2mm_joint_genotype.vcf
