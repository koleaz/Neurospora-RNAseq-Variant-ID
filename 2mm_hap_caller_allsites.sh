...
#SBATCH -o staralign/2mm_all_%A_%a.out # Standard output
#SBATCH -e staralign/2mm_all_%A_%a.err # Standard error
...
-o /n/regal/pringle_lab/koleaz/mitosnps/gvcfs_2mm/"${sra_id[SLURM_ARRAY_TASK_ID]}"2mm_all.g.vcf
